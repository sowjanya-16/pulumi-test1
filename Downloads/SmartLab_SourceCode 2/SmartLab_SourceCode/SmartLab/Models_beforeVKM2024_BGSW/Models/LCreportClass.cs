...
namespace LC_Reports_V1.Models
{
    ...
    public class WWCPC_Charts_AS_Locationwise
    {
        ...
        public List<WWCPC_Attributes_AS> WWCPC_Charts { get; set; }
    }

    public class WWCPC_charts_AS_Modelwise
    {
        public string Type { get; set; }
        public string RbCode { get; set; }
        public DateTime StartDate { get; set; }
    ...
    public class WWCPC_Attributes_AS
    {
        private int month;
        private int year;
        public string Type;
        ...
        private double ManualCaplHours;
        private double AutomatedHours;
        private double AutomatedCaplHours;
        ...
        {
            get { return this.RbCode; }

            set { this.RbCode = value; }
        }
        ...
        public double ManualUsage
        {
            get { return this.ManualHours; }
            set { this.ManualHours = value; }
        }

        public double ManualCAPLUsage
        {
            get { return this.ManualCaplHours; }
            set { this.ManualCaplHours = value; }
        }

        public double AutomatedUsage
        {
            get { return this.AutomatedHours; }
            set { this.AutomatedHours = value; }
        }

        public double AutomatedCAPLUsage
        {
            get { return this.AutomatedCaplHours; }
            set { this.AutomatedCaplHours = value; }
        }

        public double TotalUtilization
        {
            get { return this.totalUtilization; }
            set { this.totalUtilization = value; }
        }

        public string Monthyear
        {
            get { return this.Monthyr; }
            set { this.Monthyr = value; }
        }
    }

    public class WWCPC_charts_AS_OEMwise
    {
        ...
        public List<WWCPC_Attributes_AS_OEM> WWCPC_Chart_OEM { get; set; }
    }
    public class WWCPC_Attributes_AS_OEM
    {
        private int month;
        private int year;
        public string OEM;
    ...
    public class WWCPC_Attributes_AS_Avg_values
    {
        private int month;
        private int year;
        ...
        private string rbCode;
        private double totalUtilization;
        private double avgtotalUtilization;
        ...
        public int LabCount
        {
            get { return this.labCount; }

            set { this.labCount = value; }
        }

        public double AverageTotalUtilization
        {
            get { return this.avgtotalUtilization; }
            set { this.avgtotalUtilization = value; }
        }
    ...
    public class WWCPC_charts_AS_AvgUtil
    {
        public DateTime StartDate { get; set; }
        public DateTime EndDate { get; set; }
        public string StDate { get; set; }
        ...
        public List<WWCPC_Attributes_AS_Avg_values> WWCPC_Charts { get; set; }
    }

    public class WWCPC_Attributes_AS_Index_Value
    {
        private int month;
        private int year;       
        private string monthyr;
        ...
        private double totalmanhrs;
        private double totalautohrs;            
        ...
        public double TotalManualHours
        {
            get { return this.totalmanhrs; }
            set { this.totalmanhrs = value; }
        }

        public double TotalAutomatedHours
        {
            get { return this.totalautohrs; }
            set { this.totalautohrs = value; }
        }
    }

    public class WWCPC_charts_AS_IndexvaluesChart
    {
        public DateTime StartDate { get; set; }
        public DateTime EndDate { get; set; }
        public string StDate { get; set; }
        ...
        public List<WWCPC_Attributes_AS_Index_Value> WWCPC_Charts_IndexVal { get; set; }
    }

    public class MasterChartObjDetails
    {


        public WWCPC_Charts_AS_Locationwise MonthlyChartLocwisedata { get; set; }
        public WWCPC_charts_AS_Modelwise MonthlyChartModelwisedata { get; set; }
        public WWCPC_charts_AS_OEMwise MonthlyChartOEMwisedata { get; set; }
        public WWCPC_charts_AS_AvgUtil MonthlyAvgTotalUtilizationdata { get; set; }
        public WWCPC_charts_AS_IndexvaluesChart MonthlyIndexValueChartdata { get; set; }
    ...
    public class TSUAData
    {
        public List<ProjectUsersdbTSUA> projectUsersdata { get; set; }
    }

    //public class WWCPC_Attributes_AS_OEM
    //{
    //    public string Monthyear { get; set; }
    //    public List<LocUtilforOEM> ManualHours { get; set; }
    //    public List<LocUtilforOEM> ManualCaplHours { get; set; }
    //    public List<LocUtilforOEM> AutoHours { get; set; }
    //    public List<LocUtilforOEM> AutoCaplHours { get; set; }
    //}

    //public class LocUtilforOEM
    //{
    //    public string Location { get; set; }
