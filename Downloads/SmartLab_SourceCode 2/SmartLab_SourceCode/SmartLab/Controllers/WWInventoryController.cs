...
namespace LC_Reports_V1.Controllers
{
       ...
       /// </summary>
        ...
        public ActionResult Delete(int id)
        {
            try
            {
                connection();
                OpenConnection();
                string Query = " Delete from HWInventory where HW_ID = " + id;
                SqlCommand cmd = new SqlCommand(Query, conn);
                cmd.ExecuteNonQuery();
        ...
        public ActionResult Lookup()
        {
            using (BudgetingToolDB_Entities db = new BudgetingToolDB_Entities())
            {
                ...
                connection();
                OpenConnection();
                string Query = " Select * from BU_Table; Select * from OEM_Table; Select * from Groups_Table_Test; Select * from [WWInventory_Item_Table]; Select * from Currency_Table; ";
                SqlCommand cmd = new SqlCommand(Query, conn);
                SqlDataAdapter da = new SqlDataAdapter(cmd);
                da.Fill(ds);
                CloseConnection();

                WWInventory_LookupData lookupData = new WWInventory_LookupData();
                ...
                //lookupData.Item_List = db.[WWInventory_Item_Table].ToList();
                ...
                lookupData.Item_List = new List<WWInventory_Item_Table>();
                foreach (DataRow row in ds.Tables[3].Rows)
                {
                    WWInventory_Item_Table item = new WWInventory_Item_Table();
        ...
        public ActionResult Index_import(HttpPostedFileBase postedFile)
        {
                ...
                if (postedFile != null)
                {
                    ...
                    using (OleDbConnection excelOledbConnection = new OleDbConnection(excelConString))
                    {
...

                        {
                            ...
                            dt_new.Columns.Add("HW_Name", typeof(string));
                            ...
                            dt_new.Columns.Add("HIL_Name", typeof(string));
                            dt_new.Columns.Add("PC_Asset_Number", typeof(string));
                            dt_new.Columns.Add("Monitor_Asset_Number1", typeof(string));
                            dt_new.Columns.Add("Monitor_Asset_Number2", typeof(string));
                            dt_new.Columns.Add("AC_Input_Type", typeof(string));
                            dt_new.Columns.Add("ToolChain_Info", typeof(string));
                            dt_new.Columns.Add("Receiver_Name", typeof(string));
                            dt_new.Columns.Add("Receiver_Dept", typeof(string));
                            dt_new.Columns.Add("Start_Date", typeof(string));
                            dt_new.Columns.Add("End_Date", typeof(string));
                            dt_new.Columns.Add("Planned_End_Date", typeof(string));
                            dt_new.Columns.Add("Info", typeof(string));
                            dt_new.Columns.Add("Updated_By", typeof(string));
                            ...
                            for (int i = 0; i < dt1.Rows.Count; i++)
                            {
                                ...
                                row1[7] =(dt1.Rows[i][7].ToString().Trim() == "") ? string.Empty : dt1.Rows[i][7].ToString().Replace(".", "/");
                                row1[8] = dt1.Rows[i][8].ToString();
                                ...
                                row1[15]= dt1.Rows[i][15].ToString();
                                row1[16]= dt1.Rows[i][16].ToString();
                                row1[17]= dt1.Rows[i][17].ToString();
                                row1[18]= dt1.Rows[i][18].ToString();
                                row1[19]= dt1.Rows[i][19].ToString();
                                row1[20]=(dt1.Rows[i][20].ToString().Trim() == "") ? string.Empty : dt1.Rows[i][20].ToString().Replace(".", "/");
                                row1[21]=(dt1.Rows[i][21].ToString().Trim() == "") ? string.Empty : dt1.Rows[i][21].ToString().Replace(".", "/");
                                row1[22]=(dt1.Rows[i][22].ToString().Trim() == "") ? string.Empty : dt1.Rows[i][22].ToString().Replace(".", "/");
                                row1[23]= dt1.Rows[i][23].ToString();
                                row1[24]= dt1.Rows[i][24].ToString();
                            ...
                            command = new SqlCommand("select convert(nvarchar(100),Msg) as ErrorMsg from HWInventoryLog order by logtime desc", conn);
                            ...
                            if (ErrorMsg1.Count() > 0)
                            {
                                ...
                                ErrorMsg = "Error Msg: " + String.Join("\n", ErrorMsg1.ToArray());
                            }
            ...
            catch (Exception ex)
            {
                ...
                SqlCommand command = new SqlCommand("select convert(nvarchar(100),Msg) as ErrorMsg from HWInventoryLog order by logtime desc", conn);
        ...
        public ActionResult DownloadTemplate()
        {
            ...
            string filename = "WWInventory_Template.xlsx";
    ...
    public partial class WWInventory_Item_Table
    {
    ...
    public class WWInventory_LookupData
    {
        ...
        public List<WWInventory_Item_Table> Item_List { get; set; }
