...
function generateChartTSIU(data) {
    ...
    for (i = 0; i < data.length; i++) {
        ...
        if (!dayChangeFlag) {
            ...
            debugger;
            var daydiff = (Math.ceil(edDate - stDate)) / (1000 * 3600 * 24);
            var tempstart = startdatetime;
            var daydiffer = (Math.ceil(edDate - stDate)) / (1000 * 3600 * 24);
            ...
            do {
                ...
                else if (daydiff == (Math.ceil(edDate - stDate)) / (1000 * 3600 * 24)) {
                    debugger;
