...
$(document).ready(function () {
    ...
    $("#gridContainer_d1_uniquedata").prop('hidden', false); //spacing needed for user to do dropdown selections
    $("#gridContainer_d2_uniquedata").prop('hidden', false);
...
function counter_function() {
    ...
    if ((cards != undefined && cards != ' - ') && (equipments != undefined && equipments != ' - ')) {
        if (counter == (cards.length + equipments.length + 2)) {
            if (str != "Try Again") {
        ...
        if (counter == (equipments.length + 2)) {
            if (str != "Try Again") {
                $("#exportContainer").prop('hidden', false);
                var str = "Get LC info";
                var result = str.bold();
...
$("#gen").click(function () {
    ...
    $("#gridContainer_d1_uniquedata").prop('hidden', true); //since the container gap was left for dropdown selections, hide it after selections done
    $("#gridContainer_d2_uniquedata").prop('hidden', true);
    $("#gridContainer_d2cmpnt_uniquedata").prop('hidden', true);
    $("#gridContainer_d3_uniquedata").prop('hidden', true);
    $("#gridContainer_d4_uniquedata").prop('hidden', true);
    $("#gridContainer_d5_uniquedata").prop('hidden', true);
    $("#gridContainer_d6_uniquedata").prop('hidden', true);
...
function OnSuccess_d1_uniquedata(response) {
    ...
    debugger;
    if (sessions == "Latest") {
        $("#gridContainer_d1_uniquedata").prop('hidden', false);
...
function OnSuccess_d3_uniquedata(response) {
    ...
    if (sessions == "All") {
        ...
        $("#gridContainer_d3_uniquedata").prop('hidden', false);
...
function OnSuccess_d4_uniquedata(response) {
    ...
    if (sessions == "All") {
        ...
        $("#gridContainer_d4_uniquedata").prop('hidden', false);
...
function OnSuccess_d5_uniquedata(response) {
    ...
    if (sessions == "All") {
        ...
        $("#gridContainer_d5_uniquedata").prop('hidden', false);
...
function OnSuccess_d6_uniquedata(response) {
    ...
    if (sessions == "All") {
        ...
        $("#gridContainer_d6_uniquedata").prop('hidden', false);
...
function OnSuccess_d7_uniquedata(response) {
    ...
    if (sessions == "All") {
        ...
        $("#gridContainer_d7_uniquedata").prop('hidden', false);
...
function OnSuccess_d8_uniquedata(response) {
    ...
    if (sessions == "All") {
        ...
        $("#gridContainer_d8_uniquedata").prop('hidden', false);
...
function OnSuccess_d9_uniquedata(response) {
    ...
    if (sessions == "All") {
        ...
        $("#gridContainer_d9_uniquedata").prop('hidden', false);
...
function OnSuccess_d10_uniquedata(response) {
    ...
    if (sessions == "All") {
        ...
        $("#gridContainer_d10_uniquedata").prop('hidden', false);
...
function OnSuccess_d11_uniquedata(response) {
    ...
    if (sessions == "All") {
        ...
        $("#gridContainer_d11_uniquedata").prop('hidden', false);
...
function OnSuccess_d12_uniquedata(response) {
    ...
    if (sessions == "All") {
        ...
        $("#gridContainer_d12_uniquedata").prop('hidden', false);
...
function OnSuccess_d13_uniquedata(response) {
    ...
    if (sessions == "All") {
        ...
        $("#gridContainer_d13_uniquedata").prop('hidden', false);
...
function OnSuccess_d14_uniquedata(response) {
    ...
    if (sessions == "All") {
        ...
        $("#gridContainer_d14").prop('hidden', false);
        ...
        $("#gridContainer_d14_uniquedata").prop('hidden', false);
...
function OnSuccess_d15_uniquedata(response) {
    ...
    if (sessions == "All") {
        ...
        $("#gridContainer_d15").prop('hidden', false);
        ...
        $("#gridContainer_d15_uniquedata").prop('hidden', false);
...
function OnSuccess_d16_uniquedata(response) {
    ...
    if (sessions == "All") {
        ...
        $("#gridContainer_d16").prop('hidden', false);
        ...
        $("#gridContainer_d16_uniquedata").prop('hidden', false);
...
function OnSuccess_d17_uniquedata(response) {
    ...
    if (sessions == "All") {
        ...
        $("#gridContainer_d17").prop('hidden', false);
        ...
        $("#gridContainer_d17_uniquedata").prop('hidden', false);
...
function OnSuccess_d18_uniquedata(response) {
    ...
    if (sessions == "All") {
        ...
        $("#gridContainer_d18").prop('hidden', false);
        ...
        $("#gridContainer_d18_uniquedata").prop('hidden', false);
...
function OnSuccess_d19_uniquedata(response) {
    ...
    if (sessions == "All") {
        ...
        $("#gridContainer_d19").prop('hidden', false);
        ...
        $("#gridContainer_d19_uniquedata").prop('hidden', false);
...
function OnSuccess_d20_uniquedata(response) {
    ...
    if (sessions == "All") {
        ...
        $("#gridContainer_d20").prop('hidden', false);
        ...
        $("#gridContainer_d20_uniquedata").prop('hidden', false);
...
function OnSuccess_d21_uniquedata(response) {
    ...
    if (sessions == "All") {
        ...
        $("#gridContainer_d21").prop('hidden', false);
        ...
        $("#gridContainer_d21_uniquedata").prop('hidden', false);
...
function OnSuccess_d22_uniquedata(response) {
    ...
    if (sessions == "All") {
        ...
        $("#gridContainer_d22").prop('hidden', false);
        ...
        $("#gridContainer_d22_uniquedata").prop('hidden', false);
...
function OnSuccess_d23_uniquedata(response) {
    ...
    if (sessions == "All") {
        ...
        $("#gridContainer_d23").prop('hidden', false);
        ...
        $("#gridContainer_d23_uniquedata").prop('hidden', false);
...
function exportGrids() {
    ...
    var d4sheet, d5sheet, d6sheet, d7sheet, d8sheet, d9sheet, d10sheet, d11sheet,
        d11sheet, d12sheet, d13sheet, d14sheet, d15sheet, d16sheet, d17sheet,
        d18sheet, d19sheet, d20sheet, d21sheet, d21sheet, d22sheet, d23sheet, d24sheet,d25sheet;
    debugger;
    if (equipments != undefined && equipments.includes('Component Info'))
