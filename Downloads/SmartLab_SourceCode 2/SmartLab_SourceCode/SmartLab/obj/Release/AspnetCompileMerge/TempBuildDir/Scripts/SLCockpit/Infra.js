...
function infra_datagrid(data) {
    ////// //debugger;;
    var tooltipInstance = $("#tooltipContainer_infra").dxTooltip({
        //position: "right"
    }).dxTooltip("instance");
    var cchil_loc = Array.from(Array(4), () => new Array(4));
    var ccsil_loc = Array.from(Array(4), () => new Array(4));
    var otb_loc = Array.from(Array(4), () => new Array(4));
    var cs1000_loc = Array.from(Array(4), () => new Array(4));

    var tsg4_loc = Array.from(Array(4), () => new Array(4));
    var pbox_loc = Array.from(Array(4), () => new Array(4));
    var mlc_loc = Array.from(Array(4), () => new Array(4));
    var acurot_loc = Array.from(Array(4), () => new Array(4));
    ...
    for (i = 0; i < data.length; i++) {
        ...
        else if (data[i].Utilization == "TSG_PS") {
            for (j = 0; j < Locations_list.length; j++) {
                if (data[i].RBCode == Locations_list[j]) {
                    tsg4_loc[j][0] = data[i].AutoPer;
                    tsg4_loc[j][1] = data[i].ManualPer;
                    tsg4_loc[j][2] = data[i].DowntimePer;
                }
            }
        }

        else if (data[i].Utilization == "Pbox") {
            for (j = 0; j < Locations_list.length; j++) {
                if (data[i].RBCode == Locations_list[j]) {
                    pbox_loc[j][0] = data[i].AutoPer;
                    pbox_loc[j][1] = data[i].ManualPer;
                    pbox_loc[j][2] = data[i].DowntimePer;
                }
            }
        }

        else if (data[i].Utilization == "MLC") {
            for (j = 0; j < Locations_list.length; j++) {
                if (data[i].RBCode == Locations_list[j]) {
                    mlc_loc[j][0] = data[i].AutoPer;
                    mlc_loc[j][1] = data[i].ManualPer;
                    mlc_loc[j][2] = data[i].DowntimePer;
                }
            }
        }

        else if (data[i].Utilization == "ACUROT") {
            for (j = 0; j < Locations_list.length; j++) {
                if (data[i].RBCode == Locations_list[j]) {
                    acurot_loc[j][0] = data[i].AutoPer;
                    acurot_loc[j][1] = data[i].ManualPer;
                    acurot_loc[j][2] = data[i].DowntimePer;
                }
            }
        }
        ...
        onCellPrepared: function (e) {
            ...
            if (e.area === "data" && e.cell.columnType != "GT") {  //Tooltip - specific CostElement for Comparison
                if (e.cell.rowPath[0] == "CCHIL") {
                    ...
                    if (e.cell.columnPath[0] == Locations_list[2]) {
                        e.cellElement.mouseover(function (arg) {
                            e.cellElement.css("font-weight", "bold");
                            e.cellElement.addClass('dx-datagrid-action');
                            tooltipInstance.option("contentTemplate", function (contentElement) {
                                contentElement.html(`<div class='tooltipContent' style='outline-style: solid; color: black; outline-width:thin;'><div>Auto: ` + cchil_loc[2][0] + ` % , Manual: ` + cchil_loc[2][1] + ` % , DownTime ` + cchil_loc[2][2] + ` %</div><br/><div>Click to view Utilization graph<b/></div>`);//[0]->loc1 [1]loc2;  [0]->uto[1]->man
                            });

                            tooltipInstance.show(arg.target);
                        });
                    }
                    if (e.cell.columnPath[0] == Locations_list[3]) {
                        e.cellElement.mouseover(function (arg) {
                            e.cellElement.css("font-weight", "bold");
                            e.cellElement.addClass('dx-datagrid-action');
                            tooltipInstance.option("contentTemplate", function (contentElement) {
                                contentElement.html(`<div class='tooltipContent' style='outline-style: solid; color: black; outline-width:thin;'><div>Auto: ` + cchil_loc[3][0] + ` % , Manual: ` + cchil_loc[3][1] + ` % , DownTime ` + cchil_loc[3][2] + ` %</div><br/><div>Click to view Utilization graph<b/></div>`);//[0]->loc1 [1]loc2;  [0]->uto[1]->man
                            });
                    ...
                    if (e.cell.columnPath[0] == Locations_list[2]) {
                        ...
                        e.cellElement.mouseover(function (arg) {
                            ...
                            e.cellElement.addClass('dx-datagrid-action');
                            tooltipInstance.option("contentTemplate", function (contentElement) {
                                contentElement.html(`<div class='tooltipContent' style='outline-style: solid; color: black; outline-width:thin;'><div>Auto: ` + ccsil_loc[2][0] + ` % , Manual: ` + ccsil_loc[2][1] + ` % , DownTime ` + ccsil_loc[2][2] + ` %</div><br/><div>Click to view Utilization graph</div>`);
                            });
                    ...
                    if (e.cell.columnPath[0] == Locations_list[3]) {
                        ...
                        e.cellElement.mouseover(function (arg) {
                            ...
                            e.cellElement.addClass('dx-datagrid-action');
                            tooltipInstance.option("contentTemplate", function (contentElement) {
                                contentElement.html(`<div class='tooltipContent' style='outline-style: solid; color: black; outline-width:thin;'><div>Auto: ` + ccsil_loc[3][0] + ` % , Manual: ` + ccsil_loc[3][1] + ` % , DownTime ` + ccsil_loc[3][2] + ` %</div><br/><div>Click to view Utilization graph</div>`);
                            });
                   ...
                   // }
                ...
                else if (e.cell.rowPath[0] === "TSG_PS") {
                    //for (j = 0; j < Locations_list.length; j++) {
                    if (e.cell.columnPath[0] == Locations_list[0]) {
                        ...
                        e.cellElement.mouseover(function (arg) {
                            ...
                            e.cellElement.addClass('dx-datagrid-action');
                            tooltipInstance.option("contentTemplate", function (contentElement) {
                                contentElement.html(`<div class='tooltipContent' style='outline-style: solid; color: black; outline-width:thin;'><div>Auto: ` + tsg4_loc[0][0] + ` % , Manual: ` + tsg4_loc[0][1] + ` % , DownTime ` + tsg4_loc[0][2] + ` %</div><br/><div>Click to view Utilization graph</div>`);
                            });
                    ...
                    if (e.cell.columnPath[0] == Locations_list[1]) {
                        ...
                        e.cellElement.mouseover(function (arg) {
                            ...
                            e.cellElement.addClass('dx-datagrid-action');
                            tooltipInstance.option("contentTemplate", function (contentElement) {
                                contentElement.html(`<div class='tooltipContent' style='outline-style: solid; color: black; outline-width:thin;'><div>Auto: ` + tsg4_loc[1][0] + ` % , Manual: ` + tsg4_loc[1][1] + ` % , DownTime ` + tsg4_loc[0][2] + ` %</div><br/><div>Click to view Utilization graph</div>`);
                            });
                    ...
                    if (e.cell.columnPath[0] == Locations_list[0]) {
                        ...
                        e.cellElement.mouseover(function (arg) {
                            ...
                            e.cellElement.addClass('dx-datagrid-action');
                            tooltipInstance.option("contentTemplate", function (contentElement) {
                                contentElement.html(`<div class='tooltipContent' style='outline-style: solid; color: black; outline-width:thin;'><div>Auto: ` + pbox_loc[0][0] + ` % , Manual: ` + pbox_loc[0][1] + ` % , DownTime ` + pbox_loc[0][2] + ` %</div><br/><div>Click to view Utilization graph</div>`);
                            });
                    ...
                    if (e.cell.columnPath[0] == Locations_list[1]) {
                        ...
                        e.cellElement.mouseover(function (arg) {
                            ...
                            e.cellElement.addClass('dx-datagrid-action');
                            tooltipInstance.option("contentTemplate", function (contentElement) {
                                contentElement.html(`<div class='tooltipContent' style='outline-style: solid; color: black; outline-width:thin;'><div>Auto: ` + pbox_loc[1][0] + ` % , Manual: ` + pbox_loc[1][1] + ` % , DownTime ` + pbox_loc[0][2] + ` %</div><br/><div>Click to view Utilization graph</div>`);
                            });
                    ...
                    if (e.cell.columnPath[0] == Locations_list[0]) {
                        ...
                        e.cellElement.mouseover(function (arg) {
                            ...
                            e.cellElement.addClass('dx-datagrid-action');
                            tooltipInstance.option("contentTemplate", function (contentElement) {
                                contentElement.html(`<div class='tooltipContent' style='outline-style: solid; color: black; outline-width:thin;'><div>Auto: ` + mlc_loc[0][0] + ` % , Manual: ` + mlc_loc[0][1] + ` % , DownTime ` + mlc_loc[0][2] + ` %</div><br/><div>Click to view Utilization graph</div>`);
                            });
                    ...
                    if (e.cell.columnPath[0] == Locations_list[1]) {
                        ...
                        e.cellElement.mouseover(function (arg) {
                            ...
                            e.cellElement.addClass('dx-datagrid-action');
                            tooltipInstance.option("contentTemplate", function (contentElement) {
                                contentElement.html(`<div class='tooltipContent' style='outline-style: solid; color: black; outline-width:thin;'><div>Auto: ` + mlc_loc[1][0] + ` % , Manual: ` + mlc_loc[1][1] + ` % , DownTime ` + mlc_loc[0][2] + ` %</div><br/><div>Click to view Utilization graph</div>`);
                            });
                ...
                else if (e.cell.rowPath[0] === "ACUROT") {
                    //for (j = 0; j < Locations_list.length; j++) {
                    if (e.cell.columnPath[0] == Locations_list[0]) {
                        ...
                        e.cellElement.mouseover(function (arg) {
                            ...
                            e.cellElement.addClass('dx-datagrid-action');
                            tooltipInstance.option("contentTemplate", function (contentElement) {
                                contentElement.html(`<div class='tooltipContent' style='outline-style: solid; color: black; outline-width:thin;'><div>Auto: ` + acurot_loc[0][0] + ` % , Manual: ` + acurot_loc[0][1] + ` % , DownTime ` + acurot_loc[0][2] + ` %</div><br/><div>Click to view Utilization graph</div>`);
                            });
                    ...
                    if (e.cell.columnPath[0] == Locations_list[1]) {
                        ...
                        e.cellElement.mouseover(function (arg) {
                            ...
                            e.cellElement.addClass('dx-datagrid-action');
                            tooltipInstance.option("contentTemplate", function (contentElement) {
                                contentElement.html(`<div class='tooltipContent' style='outline-style: solid; color: black; outline-width:thin;'><div>Auto: ` + acurot_loc[1][0] + ` % , Manual: ` + acurot_loc[1][1] + ` % , DownTime ` + acurot_loc[0][2] + ` %</div><br/><div>Click to view Utilization graph</div>`);
                            });
...
//    bullet3.label.text = "Manual-CAPL Usage: {valueY} %";
...
//    bullet4.label.text = "Automated-CAPL Usage: {valueY} %";
