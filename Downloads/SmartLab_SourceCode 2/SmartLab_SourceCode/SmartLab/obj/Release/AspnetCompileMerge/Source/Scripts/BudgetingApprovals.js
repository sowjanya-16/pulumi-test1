            //Javascript file for Budgeting Approvals Details - mae9cob
                ...
                var BU_list, DEPT_list, Item_list, Category_list, OEM_list, Group_list, CostElement_list, OrderStatus_list, BudgetCodeList;
                var filtered_yr;
var lookup_data;
...
$.ajax({
    ...
    //    })
                    if (filtered_yr == new Date().getFullYear() + 1) {
                        ...
                        $.notify('Current VKM Requests in your Queue for HOE Review is being loaded, Please wait!', {
                            globalPosition: "top center",
                            className: "info",
                            autoHideDelay: 13000,
                        });            
                                         ...
                                         $('<a/>').addClass('dx-link')
                                             ...
                                             .on('dxclick', function () {
                                                 ...
                                                 $.ajax({
                                                     ...
                                                     type: "POST",
                                                     url: "/BudgetingApprovals/GetL1Details",
