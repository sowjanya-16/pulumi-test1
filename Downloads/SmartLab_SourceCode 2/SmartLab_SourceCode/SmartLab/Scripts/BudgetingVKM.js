...
function OnSuccess1(data) {
    ...
    if (data.success) {
       ...
       // document.getElementById("multiSelect_Submit").style.display = "block";
        ...
        //document.getElementById("btnConfigure").style.display = "block";
        document.getElementById("VKMTitle_icon").style.display = "block";
...
*/
    ...
    //popupContentTemplate_ReOrg = function () {
    //    return $('<div style="font-size:12px;">').append(
    //        $('<label style = "text-align:left;  padding-right: 10px;" id = "Depts" class= "" for= "Dept" > Choose the Ordering Stage Dept:</label>'),
    //        $('<select id="ddlDepts" class="selectpicker show-tick"  data-live-search="true" data-actions-box="true"    data-width="130px"   title="Select Dept"     style="cursor:pointer;"></select>'),
    //        $('<label style="text-align:left;  padding-left: 20px;" id="Groups" class="" for="Group"> Choose the Ordering Stage Group:</label>'),
    //        $('<select id="ddlGroups" class="selectpicker show-tick" data-live-search="true" data-actions-box="true" data-width="130px" title="Select Group" style="cursor:pointer;"></select>')
    //    )
    //};
    ...
    function changeDept() {
        ...
        const popup = $('#popup_ChangeDeptGroup').dxPopup({
            //contentTemplate: popupContentTemplate_ReOrg,
            width: '30vw',
            height: '50vh',
            container: '.dx-viewport',
            showTitle: true,
            title: 'Update Requests based on Org changes',
            visible: true,
            dragEnabled: true,
            ...
            toolbarItems: [{
                ...
                location: 'after',
                options: {
                    text: 'Update Dept & Group for the selected Requests',
                    onClick() {
                        debugger;
                        Selected = [];
                        Selected.push(reqIDarray);
                        var deptselected = document.getElementById('ddlDepts').value;
                        var grpselected = document.getElementById('ddlGroups').value;
                        popup.hide();
                        $(".selectpicker").selectpicker('refresh');
                        //update selected requests with new dept and grp chosen
                        $.ajax({
                            ...
                            async: false,
                            success: onsuccess_deptgrpdetails,
                            error: onerror_deptgrpdetails
                        })
    ...
    function onsuccess_deptgrpdetails(response) {
    ...
    function onerror_deptgrpdetails(response) {
       ////debugger;
