...
namespace LC_Reports_V1.Models
{
    ...
    public partial class RequestItems_Table
    {
        ...
        public Nullable<bool> isProjected { get; set; }
        public Nullable<decimal> Projected_Amount { get; set; }
        ...
        public Nullable<decimal> Unused_Amount { get; set; }
        public Nullable<int> L2_Qty { get; set; }
        public string L2_Remarks { get; set; }
        public string L3_Remarks { get; set; }
        public Nullable<bool> Is_UnplannedF02Item { get; set; }
        ...
        public string POCopy_FileName { get; set; }
        public string RFO_SupportingDocs_Location { get; set; }
        public string Material_Part_Number { get; set; }
        public string Supplier_Name_with_Address { get; set; }
        public string Purchase_Type { get; set; }
        public string Project_ID { get; set; }
        public string LabName { get; set; }
        public string CostCenter { get; set; }
        public string Order_Type { get; set; }
        public Nullable<System.DateTime> ELOSubmittedDate { get; set; }
        public string DaysTaken { get; set; }
        public Nullable<System.DateTime> SRSubmitted { get; set; }
        public string RFQnumber { get; set; }
        public string PRnumber { get; set; }
        public Nullable<System.DateTime> SRawardedDate { get; set; }
        public string SRApprovalDays { get; set; }
        public string SR_responsibleBuyerNTID { get; set; }
        public string SR_ManagerNTID { get; set; }
        public string POSpocNTID { get; set; }
        public string Quote_Vendor_Type { get; set; }
        public string Upload_File_Name { get; set; }
        public string RequestSource { get; set; }
        public Nullable<bool> VKMSPOC_Approval { get; set; }
