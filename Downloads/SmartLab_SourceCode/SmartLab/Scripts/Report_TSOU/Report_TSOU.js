...
function generateReportChartTSOU(data) {
    ...
    valueAxis.title.text = "Usage in Percentage";
    ...
    range.label.text = "\xa0\xa0\xa0\xa0\xa0\xa0 200%(24 hours)";
    ...
    range.grid.above = true; //to display the grid line on top of the data.
    range.label.inside = true;
    range.label.text = "\xa0\xa0\xa0\xa0\xa0\xa0 100% (12 hours)";
    range.label.fontWeight = 750;
    range.label.fill = range.grid.stroke;
    range.label.verticalCenter = "bottom";
    ...
    rangeRed.label.text = "\xa0\xa0\xa0\xa0\xa0\xa0 67% (8 hours)";
    ...
    series3.name = "Automated Capl Usage :" + Math.round((data.data.OverallAutomatedCaplHours) * 100)/100 + "hrs";
    ...
    series4.name = "Manual Capl Usage  :" + Math.round((data.data.OverallManualCaplHours) * 100) / 100 + "hrs";
