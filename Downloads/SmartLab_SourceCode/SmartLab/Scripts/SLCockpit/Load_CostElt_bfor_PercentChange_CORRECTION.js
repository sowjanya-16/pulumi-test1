                        ...
                        if (e.column.dataField.includes("Plan")) {
                            ...
                            e.cellElement.mouseover(function (arg) {
                                ...
                                tooltipInstance.option("contentTemplate", function (contentElement) {
                                    contentElement.html(`<div class='tooltipContent' style='outline-style: solid; color: black; outline-width:thin;'><div>Plan % Change (` + selected1 + `-` + selected2 + `)</div >`);
                                });
                            ...
                            e.cellElement.mouseover(function (arg) {
                                ...
                                tooltipInstance.option("contentTemplate", function (contentElement) {
                                    contentElement.html(`<div class='tooltipContent' style='outline-style: solid; color: black; outline-width:thin;'><div>Used % Change (` + selected1 + `-` + selected2 + `)</div >`);
                                });
...
function fnYear1Change() {
   ...
   // document.getElementById("ddlYear2").innerHTML = "";
    debugger;
    for (var i = sel_yr - 1; i <= sel_yr + 1; i++) {
        debugger;
        if (i != sel_yr) {
            var option = document.createElement("OPTION");
            option.innerHTML = i;
