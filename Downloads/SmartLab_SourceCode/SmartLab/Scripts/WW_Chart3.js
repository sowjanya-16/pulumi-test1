$(document).ready(function () {
    ...
    debugger;
    var data = obj.MonthlyChartOEMwisedata;
    debugger;
    excelobj = data;
    document.getElementById("gbt3").onclick = function () {
        debugger;
        Chartajax3();
    }
    document.getElementById("gbt3").disabled = true;
    document.getElementById("gbt3").style.pointerEvents = 'none';
    var sdate3;
    var edate3;
    var datestrt;
    var dateed;
    ...
    function validateDate() {
        var start = $("#sdate3").dxDateBox("option", "value");
        var end = $("#edate3").dxDateBox("option", "value");
        ...
        //re = /^\d{4}\/\d{1,2}-\d{1,2}$/;
        debugger;
        if (document.getElementById('sdate3').value == '' || document.getElementById('edate3').value == '') {
            alert("Dates not selected ");
            document.getElementById('sdate3').focus();
            return false;
        }
    ...
    function Chartajax3() {
        validatepage();
        debugger;
        var strt = $("#sdate3").dxDateBox("option", "value");
        var ed = $("#edate3").dxDateBox("option", "value");



        debugger;
        //var typeobj = $('#selectLabType').val();        
        var e = document.getElementById("selectOEM");
        oemobj = e.options[e.selectedIndex].value;
        ...
        $.ajax({
            ...
            data: JSON.stringify({ startdate: datestrt, enddate: dateed, type: typeobj, oem: oemobj }),

            contentType: "application/json; charset=utf-8",
            dataType: "json",
            success: function (data) {
                debugger;
                var data = data.data.MonthlyChartOEMwisedata;
                excelobj = data;
                generateChart3(data);
    ...
    const valueChangedHandler1 = function (e) {
        ...
        document.getElementById("gbt3").disabled = false;
        document.getElementById("gbt3").style.pointerEvents = 'auto';
    };
    ...
    $("#sdate3").dxDateBox("instance")
        .on("valueChanged", valueChangedHandler1);

    $("#edate3").dxDateBox("instance")
