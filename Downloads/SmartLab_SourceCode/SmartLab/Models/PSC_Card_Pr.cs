...
namespace LC_Reports_V1.Models
{
    ...
    public partial class PSC_Card_Pr
    {
        public string System_name { get; set; }
        public string Date { get; set; }
        public string Kernel_Loadbox_Card_PSC_CARD_BoardType { get; set; }
        public string Kernel_Loadbox_Card_PSC_CARD_Description { get; set; }
        ...
        public string Kernel_Loadbox_Card_PSC_RepairCounter { get; set; }
        public string Kernel_Loadbox_Card_PSC_PowerOnTime { get; set; }
